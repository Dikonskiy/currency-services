...
import (
	"context"
	_ "currency-get-service/docs"
	"currency-get-service/internal/config"
	"currency-get-service/internal/generated"
	"currency-get-service/internal/handlers"
...
func (a *Application) StartServer() {
	...
	grpcPort := cfg.GetEnv("GRPC_PORT", "9091")
