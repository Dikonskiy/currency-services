...
import (
	"context"
	_ "currency-delete-service/docs"
	"currency-delete-service/internal/config"
	"currency-delete-service/internal/generated"
	"currency-delete-service/internal/handlers"
...
func (a *Application) StartServer() {
	...
	grpcPort := cfg.GetEnv("GRPC_PORT", "9092")
